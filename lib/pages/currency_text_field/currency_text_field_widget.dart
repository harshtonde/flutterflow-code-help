...
class _CurrencyTextFieldWidgetState extends State<CurrencyTextFieldWidget>
  ...
  void initState() {
    ...
    _model.currencyFieldController ??= TextEditingController();
  }
                  ...
                  onTap: () async {
                    await showDialog(
                      ...
                      builder: (alertDialogContext) {
                        return AlertDialog(
                          title: Text('Currenvcy'),
                          content: Text(functions
                              .currTextToCurr(FFAppState().currencyOutput)
                              .toString()),
                          actions: [
                            TextButton(
                              onPressed: () =>
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              ...
                                              validator: _model
                                                  .currencyFieldControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ),
